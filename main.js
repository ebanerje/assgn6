function totalPrice() {
	...
	totalPrice.innerText = 3*document.getElementById("quant").value;
}
...
function populateCart(){
	...
	for (i = 0; i < cartData.length; i++){
		let cell = [cartData[i].image, cartData[i].roll, cartData[i].glaze, cartData[i].quantity, "$" + parseInt(cartData[i].quantity) * 3.00, removeButton];
